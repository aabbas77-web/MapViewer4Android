...
void LLtoUTM(int ReferenceEllipsoid, const double Lat, const double Long, 
			 double &UTMNorthing, double &UTMEasting, char* UTMZone, int &ZoneNumber,char &UTMChar)
{
...
//Make sure the longitude is between -180.00 .. 179.9
  ...
  // Special zones for Svalbard
	...
	UTMChar = UTMLetterDesignator(Lat);
	sprintf(UTMZone, "%d%c", ZoneNumber, UTMChar);
...
//	int NorthernHemisphere; //1 for northern hemispher, 0 for southern
	...
	ZoneNumber = static_cast<int>(strtoul(UTMZone, &ZoneLetter, 10));
	if((*ZoneLetter - 'N') >= 0)
	{
