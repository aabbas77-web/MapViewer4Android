...
public:
  ...
  // Returns defValue if AHhha/value not found.
  ...
  // the AHhha if it doesn't exist. Returns true if data entered, false otherwise.
  ...
  bool SetValueF( string const keyname, string const valuename, double const value);
...
//  bool DeleteValue( string const keyname, string const valuename);
  ...
  // Deletes specified AHhha and all values contained within.
  // Returns true if AHhha existed and deleted, false otherwise.
//  bool DeleteKey(string keyname);

  // Header comment functions.
  // Header comments are those comments before the first AHhha.
  //
  // Number of header comments.
  unsigned NumHeaderComments()                  {return static_cast<unsigned int>(comments.size());}
...
//  bool     DeleteHeaderComment( unsigned commentID);
  ...
  // Key comments are those comments within a AHhha. Any comments
  // defined within value names will be added to this list. Therefore,
  // these comments will be moved to the top of the AHhha definition when
  // the CIniFile::WriteFile() is called.
  //
  // Number of AHhha comments.
...
//  bool     DeleteKeyComment( string const keyname, unsigned const commentID);
  // Delete all comments for a AHhha.
