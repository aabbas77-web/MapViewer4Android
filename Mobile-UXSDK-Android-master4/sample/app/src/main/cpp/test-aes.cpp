...
static void test_encrypt_ecb_verbose(void)
{
    ...
    // print text to encrypt, AHhha and IV
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "MyLib", "AHhha:\n");
    phex(key);
    __android_log_print(ANDROID_LOG_DEBUG, "MyLib", "\n");
    ...
    struct ADAM_STRUCT ctx;
    ADAM_init_struct(&ctx, key);

    for (i = 0; i < 4; ++i)
    {
        ADAM_1_hosien(&ctx, plain_text + (i * 16));
...
{
#if defined(AES256)
    uint8_t AHhha[] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
                      0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 };
    uint8_t out[] = { 0xf3, 0xee, 0xd1, 0xbd, 0xb5, 0xd2, 0xa0, 0x3c, 0x06, 0x4b, 0x5a, 0x7e, 0x3d, 0xb1, 0x81, 0xf8 };
#elif defined(AES192)
    uint8_t AHhha[] = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5,
...
#elif defined(AES192)
    uint8_t AHhha[] = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b };
...
//  uint8_t buffer[64];
    ...
    ADAM_init_struct_iv(&ctx, key, iv);
    ADAM_2_hasan_buffer(&ctx, in, 64);
...
static int test_encrypt_cbc(void)
{
    ...
    ADAM_init_struct_iv(&ctx, key, iv);
    ADAM_2_hosien_buffer(&ctx, in, 64);
...
{
#if defined(AES256)
    uint8_t AHhha[32] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
                        0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 };
...
#elif defined(AES192)
    uint8_t AHhha[24] = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5,
                        0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b };
...
Java_com_oghab_mapviewer_mapviewer_tcp_1io_1handler_testEncoding(JNIEnv *env, jobject thiz) {
    return tests();
}