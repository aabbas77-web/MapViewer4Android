package com.oghab.mapviewer.bonuspack.routing;
...
public abstract class RoadManager {
  ...
  protected String mOptions;
	 ...
	 */
	public static MyPolyline buildRoadOverlay(MapView map, Road road, int color, float width){
		MyPolyline roadOverlay = new MyPolyline(map);
	 ...
	 */
	public static MyPolyline buildRoadOverlay(MapView map, Road road){
		return buildRoadOverlay(map, road, 0x800000FF, 5.0f);
	}
