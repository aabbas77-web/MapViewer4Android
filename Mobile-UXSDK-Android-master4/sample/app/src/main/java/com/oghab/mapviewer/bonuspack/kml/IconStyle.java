...
import com.oghab.mapviewer.bonuspack.utils.WebImageCache;
...
public class IconStyle extends ColorStyle implements Parcelable {
	...
	/** apply all IconStyle attributes to the MyMarker */
	public void styleMarker(MyMarker marker, Context context){
		...
		} //else, default MyMarker icon will be used.
		//Y coords are top->bottom for MyMarker Anchor, and bottom->up for KML hotSpot
