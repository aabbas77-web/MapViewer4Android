 ...
 * MyScaleBarOverlay scaleBar = new MyScaleBarOverlay(map); // Thiw is an important change of calling!
 * <p>
...
public class MyScaleBarOverlay extends Overlay implements GeoConstants {
    ...
    private MyScaleBarOverlay(final MapView pMapView, final Context pContext, final int pMapWidth, final int pMapHeight) {
        ...
        this.textPaint.setTextSize(Tab_Map.map_text_size * dm.density);
    ...
    private void drawLatitudeText(final Canvas canvas, final Projection projection) {
        ...
        textPaint.setTextSize(Tab_Map.map_text_size * dm.density);
    ...
    private String getConvertedScaleString(final double pMeters,
        ...
        return getScaleString(
                context,
//                String.format(Locale.getDefault(), pFormat, pMeters / pConversion.getConversionFactorToMeters()),
                String.format(Locale.ENGLISH, pFormat, pMeters / pConversion.getConversionFactorToMeters()),
                pConversion);
    }
...
//        return mMapView != null ? mMapView.getWidth() : mMapWidth;
        return mMapWidth > 0?mMapWidth:mMapView.getWidth();
    }
...
//        return mMapView != null ? mMapView.getHeight() : mMapHeight;
        return mMapHeight > 0?mMapHeight:mMapView.getHeight();
    }
}
