 ...
 * {@link org.osmdroid.views.overlay.MyMarker}.
 * <p>
 * It handles
 * <p>
 ...
 * R.id.bubble_image          = {@link org.osmdroid.views.overlay.MyMarker#getImage()}
 * <p>
 ...
 *
 * <img alt="Class diagram around MyMarker class" width="686" height="413" src='./doc-files/marker-infowindow-classes.png' />
 *
 * @author M.Kergall
 */
public class MyMarkerInfoWindow extends MyBasicInfoWindow {

    protected MyMarker mMarkerRef; //reference to the MyMarker on which it is opened. Null if none.
    ...
    /**
     * reference to the MyMarker on which it is opened. Null if none.
     *
     * @return
     */
    public MyMarker getMarkerReference() {
        return mMarkerRef;
    }
