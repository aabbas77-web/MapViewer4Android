...
public class KmlPlacemark extends KmlFeature implements Cloneable, Parcelable {
	...
	/** constructs a Placemark from a MyMarker, as a KML Point */
	public KmlPlacemark(MyMarker marker){
	...
	public KmlPlacemark(MyPolygon polygon, KmlDocument kmlDoc){
		this();
	...
	public KmlPlacemark(MyPolyline polyline, KmlDocument kmlDoc){
		this();
