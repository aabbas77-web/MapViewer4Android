...
import com.oghab.mapviewer.bonuspack.clustering.MarkerClusterer;
import com.oghab.mapviewer.bonuspack.overlays.GroundOverlay;
...
public class KmlFolder extends KmlFeature implements Cloneable, Parcelable {
	...
	public boolean addOverlay(Overlay overlay, KmlDocument kmlDoc){
		...
		} else if (overlay instanceof MyMarker){
