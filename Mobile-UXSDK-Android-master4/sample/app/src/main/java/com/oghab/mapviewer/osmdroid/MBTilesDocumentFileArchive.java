...
import com.oghab.mapviewer.osmdroid.IArchiveDocumentFile;
import com.oghab.mapviewer.utils.ASFUtils;
 ...
 */
public class MBTilesDocumentFileArchive implements IArchiveDocumentFile {

    private SQLiteDatabase mDatabase;

    public MBTilesDocumentFileArchive() {
    }
    ...
    private MBTilesDocumentFileArchive(final SQLiteDatabase pDatabase) {
        mDatabase = pDatabase;
    }

    public static MBTilesDocumentFileArchive getDatabaseFileArchive(final File pFile) throws SQLiteException {
        return new MBTilesDocumentFileArchive(
    ...
    @Override
    public void init(DocumentFile pFile) throws Exception {
        String path = ASFUtils.getPath(MainActivity.ctx, pFile.getUri());
