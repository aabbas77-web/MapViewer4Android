...
//import com.oghab.mapviewer.bonuspack.overlays.Polygon;
import com.oghab.mapviewer.mapviewer.MyPolygon;
...
public abstract class KmlFeature implements Parcelable, Cloneable {
	 ...
	 * Note that an applyDefaultStyling method is available, to perform default styling if needed. */
	 public interface Styler {
		...
		abstract void onPoint(MyMarker marker, KmlPlacemark kmlPlacemark, KmlPoint kmlPoint);
		/** called on each KmlPoint */
		abstract void onLineString(MyPolyline polyline, KmlPlacemark kmlPlacemark, KmlLineString kmlLineString);
		/** called on each KmlPoint */
		abstract void onPolygon(MyPolygon polygon, KmlPlacemark kmlPlacemark, KmlPolygon kmlPolygon);
		/** called on each KmlTrack */
		abstract void onTrack(MyPolyline polyline, KmlPlacemark kmlPlacemark, KmlTrack kmlTrack);
	}
